...
public class ActorActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return ActorFragment.newInstance(position);
        }
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.actors_pager_all);
                case 1:
                    return getString(R.string.actors_pager_men);
                case 2:
                    return getString(R.string.actors_pager_women);
            }
            return null;
        }
    }
